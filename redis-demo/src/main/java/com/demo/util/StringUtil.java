 ...
 * @createDate 2018年2月27日 下午5:19:21
 */
public class StringUtil {
    ...
    public static Properties getProperties(String connectionProperties) {
        ...
        String[] sp1 = connectionProperties.split(";");
        if (sp1 != null && sp1.length > 0) {
            for (String str : sp1) {
                String[] sp2 = str.split("=");
                for (String s : sp2) {
                    p.setProperty(sp2[0], sp2[1]);
                }
            }
        }
        return p;
     ...
     * *************************************************************************
     *
     * @author 李锋 2007.4.18 &#31119;test&#29031;&#27004;&#65288;&#21271;&#22823;&#38376;&# 24635
     *         ;&#24215;&#65289;&#31119;
     * @return 经过解码的内容
     *************************************************************************
     */
    ...
    /**
     * 泛型方法(通用)，把list转换成以“,”相隔的字符串 调用时注意类型初始化（申明类型） 如：List<Integer> intList = new ArrayList<Integer>();
     * 调用方法：StringUtil.listTtoString(intList); 效率：list中4条信息，1000000次调用时间为850ms左右
     *
     * @author fengliang
